          ...
          <div class="section">
            <div class="view row">
              <div class="button-add">
                <button type="button" name="add_game" @click="goTo('index2')">New Index</button>
              </div>
              <div class="button-add">
            ...
            <table>
              ...
              <tbody>
                <tr v-for="game in games">
                  <td @click="goTo('index2')">{{ game.games.length }}</td>
                  <td @click="goTo('index2')">{{ game.date }}</td>
                  <td @click="goTo('index2')">{{ !game.checked?'Não Conferido':`${game.hits} acertos` }}</td>
